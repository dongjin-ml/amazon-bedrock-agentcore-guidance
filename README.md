# 🚀 Amazon Bedrock AgentCore 튜토리얼 시리즈

## 소개

Amazon Bedrock AgentCore는 프로덕션급 AI 에이전트를 구축하고 운영할 수 있는 AWS의 에이전트 플랫폼입니다.

이번 re:Invent 2025에서 AgentCore 관련 기능들이 많은 관심을 받았습니다. AWS Korea SA 팀이 AgentCore의 주요 컴포넌트별 튜토리얼을 준비했습니다.
...
`#AWSAgentCore` `#생성형AI` `#AmazonBedrock` `#AI에이전트`
